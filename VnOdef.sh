...
# set repo
wget -O /etc/apt/sources.list "https://raw.githubusercontent.com/hiphop2531/OCS_AUTO_GOOD/master/sources.list.debian7"
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/hiphop2531/OCS_AUTO_GOOD/master/nginx.conf"
mkdir -p /home/vps/public_html
echo "<pre>Setup by Clrkz</pre>" > /home/vps/public_html/index.html
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/hiphop2531/OCS_AUTO_GOOD/master/vps.conf"
service nginx restart

# install openvpn
wget -O /etc/openvpn/openvpn.tar "https://raw.githubusercontent.com/hiphop2531/OCS_AUTO_GOOD/master/openvpn-debian.tar"
cd /etc/openvpn/
tar xf openvpn.tar
wget -O /etc/openvpn/1194.conf "https://raw.githubusercontent.com/hiphop2531/OCS_AUTO_GOOD/master/1194.conf"
service openvpn restart
sysctl -w net.ipv4.ip_forward=1
sed -i 's/#net.ipv4.ip_forward=1/net.ipv4.ip_forward=1/g' /etc/sysctl.conf
iptables -t nat -I POSTROUTING -s 192.168.100.0/24 -o eth0 -j MASQUERADE
iptables-save > /etc/iptables_yg_baru_dibikin.conf
wget -O /etc/network/if-up.d/iptables "https://raw.githubusercontent.com/hiphop2531/OCS_AUTO_GOOD/master/iptables"
chmod +x /etc/network/if-up.d/iptables
service openvpn restart

# konfigurasi openvpn
cd /etc/openvpn/
wget -O /etc/openvpn/client.ovpn "https://raw.githubusercontent.com/hiphop2531/OCS_AUTO_GOOD/master/client-1194.conf"
sed -i $MYIP2 /etc/openvpn/client.ovpn;
cp client.ovpn /home/vps/public_html/

# install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/hiphop2531/OCS_AUTO_GOOD/master/badvpn-udpgw"
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/hiphop2531/OCS_AUTO_GOOD/master/badvpn-udpgw64"
fi
...
wget -O /etc/squid3/squid.conf "https://raw.githubusercontent.com/hiphop2531/OCS_AUTO_GOOD/master/squid3.conf"
...
wget https://raw.githubusercontent.com/hiphop2531/OCS_AUTO_GOOD/master/ddos-deflate-master.zip 
...
wget -O /etc/issue.net "https://raw.githubusercontent.com/hiphop2531/OCS_AUTO_GOOD/master/issue.net"
...
# download script
cd /usr/bin
wget -O menu "https://raw.githubusercontent.com/hiphop2531/OCS_AUTO_GOOD/master/menu.sh"
wget -O usernew "https://raw.githubusercontent.com/hiphop2531/OCS_AUTO_GOOD/master/usernew.sh"
wget -O trial "https://raw.githubusercontent.com/hiphop2531/OCS_AUTO_GOOD/master/trial.sh"
wget -O delete "https://raw.githubusercontent.com/hiphop2531/OCS_AUTO_GOOD/master/hapus.sh"
wget -O check "https://raw.githubusercontent.com/hiphop2531/OCS_AUTO_GOOD/master/user-login.sh"
wget -O member "https://raw.githubusercontent.com/hiphop2531/OCS_AUTO_GOOD/master/user-list.sh"
wget -O restart "https://raw.githubusercontent.com/hiphop2531/OCS_AUTO_GOOD/master/resvis.sh"
wget -O speedtest "https://raw.githubusercontent.com/hiphop2531/OCS_AUTO_GOOD/master/speedtest_cli.py"
wget -O info "https://raw.githubusercontent.com/hiphop2531/OCS_AUTO_GOOD/master/info.sh"
wget -O about "https://raw.githubusercontent.com/hiphop2531/OCS_AUTO_GOOD/master/about.sh"
